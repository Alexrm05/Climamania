...
if ($_SESSION['k_rol'] == 'adminfriconter') {
	...
	$sql = "SELECT * FROM ClimaInstal_events where equipo_instaladores = 'FCB' or equipo_instaladores = 'FCB2' ";
};
...
$sql3 = "SELECT FIN.Referencia, FIN.Usuario , EVE.estado, EVE.title 
		...
		where EVE.estado IS NULL ";
							...
							while ($row = $req3->fetch()){
								...
								$sql = "UPDATE ClimaInstal_events SET  estado = '$Operario', title = '$texto'  WHERE referencia = $referenciaF ";
