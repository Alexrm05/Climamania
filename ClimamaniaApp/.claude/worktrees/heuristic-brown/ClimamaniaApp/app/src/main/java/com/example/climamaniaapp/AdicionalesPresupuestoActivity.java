...
public class AdicionalesPresupuestoActivity extends BaseActivity {
    ...
    private static final String[] GUARDAR_PRESUPUESTO_URLS = new String[]{
            ...
            "https://app.clminstal.es/guardar_presupuesto_instalador.php",
            "https://clminstal.es/api/guardar_presupuesto_instalador.php",
            "https://clminstal.es/guardar_presupuesto_instalador.php"
    };
    ...
    private void submitPresupuesto() {
        ...
        Map<String, String> payload = buildPresupuestoPayload(firmaBase64, lineasJson);
    ...
    private Map<String, String> buildPresupuestoPayload(String firmaBase64, JSONArray lineasJson) {
    ...
    private void setSavingPresupuesto(boolean saving) {
        ...
        if (btnAceptar != null) {
            ...
            btnAceptar.setText(saving ? "Guardando..." : "Aceptar");
        }
    }
    ...
    private void refreshLineAmounts(TextView txtUnit, TextView txtTotal, TextView txtIvaInfo, BudgetLine line) {
        txtUnit.setText("P. unit: " + formatCurrency(line.unitSinIva) + " (sin IVA)");
        txtTotal.setText("Total: " + formatCurrency(line.totalSinIva));
        String ivaLabel = "IVA " + formatPercent(line.product.ivaPct) + " · Total c/IVA " + formatCurrency(line.totalConIva);
