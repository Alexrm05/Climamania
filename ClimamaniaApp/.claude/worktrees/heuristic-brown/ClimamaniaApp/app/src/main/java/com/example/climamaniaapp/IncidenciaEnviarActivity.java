...
public class IncidenciaEnviarActivity extends BaseActivity {
    ...
    private static final String URL_ENVIAR_COMENTARIO =
            "https://app.clminstal.es/api/incidencia_enviar_comentarios.php";
    private static final String URL_ENVIAR_FOTO_VIDEO =
            "https://app.clminstal.es/api/incidencia_enviar_fotos.php";
    private static final String URL_CAMBIAR_PRIORIDAD =
            "https://app.clminstal.es/api/incidencia_cambiar_prioridad.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView txtTitulo = content.findViewById(R.id.txtVisitaEnviarTitulo);
        ...
        if (txtTitulo != null) {
            txtTitulo.setText("Que quieres hacer con la incidencia?");
        }
        if (btnPrioridad != null) {
            btnPrioridad.setText("Cambiar prioridad de la incidencia");
        }
        if (btnFinalizar != null) {
            btnFinalizar.setText("Finalizar / Cancelar incidencia");
        }
    ...
    private void showPrioridadDialog() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("Cambiar prioridad de la incidencia")
    ...
    private void abrirPantallaCierre() {
        ...
        intent.putExtra("tipo_caso", "incidencia");
        intent.putExtra("id_caso", idIncidencia);
    ...
    private void abrirCamara() {
        ...
        try {
            File cacheDir = new File(getCacheDir(), "incidencias");
            if (!cacheDir.exists()) {
                cacheDir.mkdirs();
            }
            tempPhotoFile = File.createTempFile("incidencia_", ".jpg", cacheDir);
    ...
    private void abrirCamaraVideo() {
        ...
        try {
            ...
            tempVideoFile = File.createTempFile("incidencia_video_", ".mp4", cacheDir);
